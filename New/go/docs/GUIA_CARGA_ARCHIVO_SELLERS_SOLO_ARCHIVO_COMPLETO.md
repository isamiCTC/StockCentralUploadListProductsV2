...
Este instructivo está orientado al archivo completo, que se usa para:

- dar de alta productos nuevos;
- actualizar datos generales de un producto ya existente;
- informar stock junto con el resto de la ficha.
...
- por eso conviene copiarla exactamente como figura en el sitio.
...
- la clasificación del producto puede no resolverse correctamente.
...
1. Usá el archivo completo para altas de productos y actualizaciones generales.
2. Si querés dar de baja un producto, dejalo con stock `0`.
3. No cambies la estructura del Excel.
4. Escribí bien el `SKU` antes de subir el archivo.
5. En stock usá siempre números enteros.
6. En medidas cargá alto, ancho y largo en centímetros.
7. En peso cargá el valor en gramos.
8. En imágenes usá links completos y en el orden en que quieras que queden.
9. En categoría y subcategoría copiá exactamente lo que figura en Club Patagonia.
10. Si querés quitar una oferta, volvé a subir el producto con `OFERTA` vacío.
11. Guardá siempre el archivo final en formato Excel (técnicamente, `.xlsx`).
12. Antes de cada carga, revisá la plantilla y los datos principales.
